...
public class Task5 {
  ...
  5) Натуральное число называется числом Армстронга, если сумма цифр числа, возведенных в N-ную степень (где N – количество цифр в числе) равна самому числу.
    ...
    /*
    Алгоритм:
    1) присвоить полученное число числу
    2) отделить каждую цифру
    3) если (первая цифра уиноженная на себя три раза) +
            (вторая цифра умноженная на себя три раза) +
            (третья цифра умноженная на себя три раза) равно
